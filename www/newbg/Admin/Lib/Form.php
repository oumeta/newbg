...
class Form {
	...
	public static function editor($textareaid = 'content', $toolbar = 'basic', $module = '', $catid = '', $color = '', $allowupload = 0, $allowbrowser = 1,$alowuploadexts = '',$height = 200,$disabled_page = 0, $allowuploadnum = '10') {
		$str ='';
		 ...
		 if(!defined('EDITOR_INIT')) {
			// echo 333;
			$str = '<script type="text/javascript" src="'.APPPUBLIC.'ckeditor/ckeditor.js"></script>';
			
			define('EDITOR_INIT', 1);
		 }
		//echo 333;
		if($toolbar == 'basic') {
			$toolbar = defined('IN_GENV') ? "['Source']," : '';
		...
		<div>
        	<span   class='yui-button yui-push-button'><span class='first-child'><button id='btupload' tabindex='0' type='button'>上传</button></span></span>
		</div>
		 </div>";
		$ext_str .= "</div>";
		$str .= $ext_str;
	...
	public static function images($name, $id = '', $value = '', $moudle='', $catid='', $size = 50, $class = '', $ext = '', $alowexts = '',$thumb_setting = array(),$watermark_setting = 0 ) {
		...
		if(!defined('IMAGES_INIT')) {
			$str = '<script type="text/javascript" src="'.APPPUBLIC.'swfupload/swf2ckeditor.js"></script>';
	...
	public static function date($name, $value = '', $isdatetime = 0, $loadjs = 0, $showweek = 'true') {
		...
		if($loadjs || !defined('CALENDAR_INIT')) {
			...
			$str .= '<link rel="stylesheet" type="text/css" href="'.APPPUBLIC.'calendar/jscal2.css"/>
			<link rel="stylesheet" type="text/css" href="'.APPPUBLIC.'calendar/border-radius.css"/>
			<link rel="stylesheet" type="text/css" href="'.APPPUBLIC.'calendar/win2k.css"/>
			<script type="text/javascript" src="'.APPPUBLIC.'calendar/calendar.js"></script>
			<script type="text/javascript" src="'.APPPUBLIC.'calendar/lang/en.js"></script>';
		}

...
<ul id="contextMenus" style="display:none;position:absolute;z-ingdex:2020">			 
	...
	<li data="power">编辑权限</li>
	<li data="billpower">订单权限</li>
</ul>
...
<div id="DataGrid" class=DataGrid style='align:left;display:none' url='<?=$datasrc?>'>
	<ul>
		...
		<li title='角色名' id='name' width="80"></li>
		<li title='状态' id='status' width="50"></li>
		<li title='备注' id='remark' width="50"></li>
	</ul> 
...
<div style="z-index: 2; visibility: visible; left: 450px; top: 40px;width:300px;" class="yui-module yui-overlay " id="classPath">
    ...
    <form id="myform">
        <fieldset>
            ...
            <div >
			 ...
			 <div >
				<label>
				 <input type="text" style='display:none' size="20"  name='id' id='id'    />
...
$("#btsave").click(function(){
	...
	$("#contextMenus").click(function(e) {
			...
			if(t=='edit'){
				...
				window.location.href=PI.APP+"/power/index/?roleid="+data[row].id+"&mid="+PI.mid
			
			}else if(t=='billpower'){
			
				window.location.href=PI.APP+"/power/billpower/?roleid="+data[row].id+"&mid="+PI.mid

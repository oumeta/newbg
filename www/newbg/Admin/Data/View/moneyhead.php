...
<title></title>    
 <!--[if IE]>
    <link rel="stylesheet" href="<?=$_public?>newcss/ie.css" type="text/css" media="screen, projection" />
  <![endif]-->
<style type="text/css">
 @import url(<?=$_public?>newcss/money.css);
 @import url(<?=$_public?>newcss/date_input.css);
</style>
<script src="<?=$_public?>newjs/jquery.js" type="text/javascript"></script>
<script src="<?=$_public?>newjs/jquery.date_input.js" type="text/javascript"></script>

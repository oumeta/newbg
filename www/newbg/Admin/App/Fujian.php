...
class FujianAction extends GlobalAction{
	#上传管理 
	...
	$IMAGE_FILE_TYPE="zip|xlsx|csv|xls|word|docx|doc|txt|jpg|gif|png|bmp|pdf";
        ...
        redirect(U('actbill/download',array('bid'=>getgpc('bid'))));
    }
	function getdown(){

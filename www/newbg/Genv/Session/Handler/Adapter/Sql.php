 ...
 * 
 */
class Genv_Session_Handler_Adapter_Sql extends Genv_Session_Handler_Adapter
{
    /**
     * 
     * Default configuration values.
     * 
     * @config dependency sql A Genv_Sql dependency injection.
     * 
     ...
     * 
     */
    protected $_Genv_Session_Handler_Adapter_Sql = array(
        'sql'         => 'sql',
        'table'       => 'sessions',
        'id_col'      => 'id',
        'created_col' => 'created',
    ...
    /**
     * 
     * Genv_Sql object to connect to the database.
     * 
     * @var Genv_Sql_Adapter
     * 
     */
    protected $_sql;

 ...
 * 
 * {{code: php
 *     $response = Genv::factory('Genv_Http_Response');
 ...
 * 
 */
class Genv_Http_Response extends Genv_Base
{
    /**
     * 
     ...
     * 
     * @return Genv_Http_Response This response object.
     * 
     * @throws Genv_Http_Response_Exception_HttpVersion when the version number
     * is not '1.0' or '1.1'.
     * 
     */
...
/**
     ...
     * the [[Genv_Http_Response::setStatusCode() | ]] and 
     * [[Genv_Http_Response::setStatusText() | ]] methods instead.
     * 
     ...
     * 
     * @param Genv_Uri_Action|string $spec The URI to redirect to.
     * 
     ...
     * 
     * This method calls [[Genv_Http_Response::setNoCache() | ]] to disable
     * caching.
     * 
     * @param Genv_Uri_Action|string $spec The URI to redirect to.
     * 
     ...
     * @return void
     * 
     * @throws Genv_Http_Response_Exception_HeadersSent if headers have
     * already been sent.
     * 
     */
    ...
    public function goBack($suffix = NULL, $default = NULL)
    {
        ...
        if (!empty($referer)) {
            ...
            if (!empty($suffix)) {
                ...
                $referer = Genv_Common::buildUrl($parts);
            }

...
abstract class Genv_Cache_Adapter extends Genv_Base {
    
   
    protected $_Genv_Cache_Adapter = array(
        'active' => true,
        'life'   => 0,
        'prefix' => null,
    );
     ...
     *     // Genv_Example::createData($id) to create the data for saving 
     *     // if it does not exist.
     *     $callback = array('Genv_Example', 'createData');
     *     $args = array($id);
     ...
     *     
     *     // fetch that ID from the cache, but use a static method callback
     *     // Genv_Example::createData($id) to create the data for adding 
     *     // if it does not exist.
     *     $callback = array('Genv_Example', 'createData');
     *     $args = array($id);
     ...
     * cache entries.  For example, the [Genv_Cache_Adapter_File:HomePage file adapter]

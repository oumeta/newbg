...
class Genv_Session extends Genv_Base
{
    /**
     * 
     ...
     *   'Genv'.
     * 
     * @config dependency handler A Genv_Session_Handler dependency injection. Default
     ...
     * 
     * @var Genv_Session_Handler_Adapter
     * 
     */
     ...
     * 
     * Convenience reference to $_SESSION['Genv_Session']['flash'][$this->_class].
     * 
     * @var array
     * 
     */
    ...
    protected function _postConstruct()
    {
        ...
        if (! self::$_handler) {
            self::$_handler = Genv::dependency(
                'Genv_Session_Handler',
        ...
        if (! self::$_request) {
            self::$_request = Genv_Registry::get('request');
        }
    ...
    public function load()
    {
        ...
        if (empty($_SESSION['Genv_Session']['flash'][$this->_class])) {
            $_SESSION['Genv_Session']['flash'][$this->_class] = array();
        }
        $this->_flash =& $_SESSION['Genv_Session']['flash'][$this->_class];
     ...
     *     }
     * 
     * Would need to have Genv_Request access for this to work like the rest
     * of Genv does.
     * 
     */

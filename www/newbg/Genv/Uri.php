 ...
 * 
 * > Note: For controller action URIs, use [[Genv_Uri_Action]].
 * > Likewise, for public resource URIs, use [[Genv_Uri_Public]].
 * 
 ...
 * 
 * You can use Genv_Uri to parse this complex string very easily:
 * 
 * {{code: php
 ...
 * the parsed URI processed by [[Genv_Uri::set()]]. They are ...
 * 
 ...
 * @category Genv
 * 
 * @package Genv_Uri Representation and manipulation of URIs (generic, 
 * action, and public).
 * 
 ...
 * 
 */
class Genv_Uri extends Genv_Base
{
    /**
     * 
     ...
     *   for specific URI subclasses, for example Genv_Uri_Public.
     * 
     * @config string path A path prefix.  Generally needed only
     *   for specific URI subclasses, for example Genv_Uri_Action.
     * 
     ...
     * __get() with $query.
     * 
     * If you access this property, Genv_Uri treats Genv_Uri::$query as
     * authoritative, *not* the internal Genv_Uri::$_query_str. If the
    ...
    /**
     * 
     * Sets the query string in the URI, for Genv_Uri::getQuery() and
     * Genv_Uri::$query.
     * 
    ...
    /**
     * 
     * Returns the query portion as a string.  When [[Genv_Uri::$_query | ]]
     * is non-null, uses [[php::http_build_query() | ]] on it; otherwise, 
     * returns the [[Genv_Uri::$_query_str]] property.
     * 
    ...
    /**
     * 
     * Sets the Genv_Uri::$path array from a string.
     * 
     ...
     * characters found in Genv_Uri::$_encode_path.
     * 
